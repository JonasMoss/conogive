...
with one latent factor. This package has functions to estimate such models, 
calculate their ordinal reliabilities, and make predictions.
...
Estimate a congeneric ogive model with `congive`, predict the value of the 
